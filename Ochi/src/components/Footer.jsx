...
const Footer = () => {
  return (
    <div className='w-full h-screen grid grid-cols-2'>
        <div className='px-15 flex flex-col justify-between py-10 pt-25'>
            <div>
                <h1 className='uppercase text-[9vw] tracking-wide leading-[6.5vw] font-[ochi1]'>Eye-</h1>
                <h1 className='uppercase text-[9vw] tracking-wide leading-[6.5vw] font-[ochi1]'>Opening</h1>
            </div>
            <svg
                    width="72"
                    height="30"
        ...
        <div className='py-10 pt-25 pr-15'>
            <h1 className='uppercase text-[9vw] tracking-wide leading-[6.5vw] font-[ochi1]'>Presentations</h1>
            <div className='w-full h-[70%] mt-10 flex justify-between'>
                <div className='flex flex-col justify-between'>
                    <div className='flex flex-col'>
                        S: 
                        <a className='mt-3' href="#">Instagram</a>
                        <a href="#">Dribble</a>
                        <a href="#">Facebook</a>
                        <a href="#">LinkedIn</a>
                    </div>
                    <div className='flex flex-col'>
                       L: 
                       <a className='mt-3' href="#">202-1965 W 4th Ave</a> 
                       <a href="#">Vancouer , Canada</a> 
                       <a className='mt-5' href="#">30 Chukrina St</a>
                       <a href="#">Lviv, Ukraine</a>
                    </div>
                    <div className='flex flex-col'>
                        E:
                        <a className='mt-3' href="#">hello@ochi.design</a>
                    </div>
                </div>
                <div className='flex flex-col justify-center pt-25'>
                    M:
            ...
            <div className='flex justify-between mt-8 text-md text-zinc-300'>
                <h1>&copy;ochi.design 2025. Legal Terms</h1>
