...
const Page2 = () => {
  ...
  return (
    <div
      id="page2"
      className="bg-white text-black text-center p-10 font-[anzo1]"
    >
      <h3 className="text-gray-500 text-xl">
        © anzo.studio 2025 | designed and developed
      </h3>
      <div className="rotatetext mt-10">
        <h1 className="text-center text-[40vw] uppercase font-[anzo2] leading-[35vw] -tracking-tight">
          Impactful
        </h1>
      </div>
            ...
            <g clipPath="url(#96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2)">
              <g filter="url(#aef381e0-a01b-4767-81f9-2c2e04143cb9_comp-lmyox36t2)">
                <mask
                  ...
                  id="6fdfdaea-c66e-4c33-992f-dbf7b68cfcfc_comp-lmyox36t2"
                  fill="none"
                >
                  <path
                    fill="#ffffff"
      ...
      <div className="h-1 w-1/3 bg-gray-600 relative left-1/2 -translate-x-1/2 mt-20"></div>
    </div>
  );
};
